...
from mamba_attn import HybridMamba2Config, HybridMamba2ForCausalLM
import os 
from accelerate import PartialState
from mamba_attn import Mamba2AttentionModel
...
model = HybridMamba2ForCausalLM(config)  #AutoModelForCausalLM.from_pretrained("state-spaces/mamba-130m-hf", use_cache=False, device_map={'':device_string})
